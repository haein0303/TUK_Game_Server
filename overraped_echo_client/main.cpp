...
public:
	EXP_OVER(char s_id, const char num_bytes, char* mess) : _s_id(s_id)
	{
...
public:
	...
	void do_send(unsigned long long sender_id, int num_bytes, char* mess) {
...
void CALLBACK send_callback(DWORD err, DWORD num_bytes, LPWSAOVERLAPPED send_over, DWORD f)
{
